...
main:
  ...
  expect (semver.is_valid --no-require_major_minor_patch "1")
  expect (semver.is_valid --no-require_major_minor_patch "1.2")
  expect (semver.is_valid --no-require_major_minor_patch "1-alpha")
  expect (semver.is_valid --no-require_major_minor_patch "1.2-alpha")
  expect (semver.is_valid --no-require_major_minor_patch "1-beta+a-z.A-Z.0-9.00")
  expect (semver.is_valid --no-require_major_minor_patch "1.0-beta+a-z.A-Z.0-9.00")

  expect_not (semver.is_valid --no-require_major_minor_patch "1.0.0-+build.1+build.2")
  expect_not (semver.is_valid --no-require_major_minor_patch "1.0.0-01")
  expect_not (semver.is_valid --no-require_major_minor_patch "1.0.0-ä")

  expect_not (semver.is_valid --no-require_major_minor_patch --no-allow_v "v1.0.0")
  expect_not (semver.is_valid --no-require_major_minor_patch --no-allow_v "v1")
